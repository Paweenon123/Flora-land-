...
if(isset($_POST['update_order'])){
   ...
   mysqli_query($conn, "UPDATE orders SET payment_status = '$update_payment' WHERE oid = '$order_id'") or die('query failed');
   $message[] = 'payment status has been updated!';
}

if(isset($_GET['delete'])){
   $delete_id = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM orders WHERE oid = '$delete_id'") or die('query failed');
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post">
            <input type="hidden" name="order_id" value="<?php echo $fetch_orders['oid']; ?>">
            ...
            <a href="admin_orders.php?delete=<?php echo $fetch_orders['oid']; ?>" class="delete-btn" 
